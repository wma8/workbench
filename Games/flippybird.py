...
def createMap():
    ...
    screen.blit(Pipeline.pineUp, (Pipeline.wallx, -300 + Pipeline.rand))   # 上管道坐标位置
    screen.blit(Pipeline.pineDown, (Pipeline.wallx, 500 + Pipeline.rand))  # 下管道坐标位置
...
def checkDead():
    upRect = pygame.Rect(Pipeline.wallx, -300 + Pipeline.rand,
                         Pipeline.pineUp.get_width() - 10,
                         Pipeline.pineUp.get_height())

    # 下方管子的矩形位置
    downRect = pygame.Rect(Pipeline.wallx, 500 + Pipeline.rand,
